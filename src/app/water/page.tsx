...
export default function WaterManagement() {
  ...
  const [unitPrice, setUnitPrice] = useState('5.00'); // 默认水价 5.00 元/吨
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-bold text-gray-900">💧 水费管理</h1>
        ...
        {step === 'tenant' && (
          <>
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">创建水费账单</h2>
              <p className="text-gray-600">选择租户，输入用水量生成账单</p>
            </div>
            ...
            {tenants.length === 0 ? (
              <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">需要租户入住后才能创建水费账单</p>
                <Link
                  href="/checkin"
                ...
                {selectedTenant && (
                  <div className="bg-white rounded-2xl shadow-xl p-6 space-y-4">
                    ...
                    <button
                      ...
                      disabled={!usage}
                      className="w-full px-6 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed font-semibold text-lg"
                    >
                      下一步
                    </button>
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between items-center py-3 border-b">
                ...
                <span className="font-semibold text-gray-900">{usage} 吨</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b">
                <span className="text-gray-600">单价</span>
                <span className="font-semibold text-gray-900">￥{unitPrice}/吨</span>
              </div>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full px-6 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:bg-gray-300 font-semibold text-lg"
              >
                {loading ? '生成中...' : '确认生成账单'}
              </button>
              <button
        ...
        {step === 'success' && selectedTenant && (
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="space-y-3">
              <button
                onClick={handleReset}
                className="w-full px-6 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold text-lg"
              >
                继续创建账单
              </button>
              <Link
